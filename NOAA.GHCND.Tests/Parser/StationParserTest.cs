...
namespace NOAA.GHCND.Tests.Parser
{
    ...
    public class StationParserTest
    {
        ...
        public void WillParseDataPoint()
        {
            ...
            new StationParserRule().TryParseData(validDataPoint, out data).Should().BeTrue();
            data.Should().Be(13);
            new StationParserRule().TryParseData(invalidDataPoint, out data).Should().BeFalse();
            new StationParserRule().TryParseData(missingDataPoint, out data).Should().BeFalse();
        }
        ...
        public void WillNotParseDifferentStation()
        {
            ...
            var station = new StationData("DIFFERENTSTATION");

            Action exceptionThrowingAction = () => new StationParserRule().ParseStationLine(line, station);
        ...
        public void WillParseStationData()
        {
            ...
            var station = new StationData("AJ000037735");

            new StationParserRule().ParseStationLine(line, station);
